...
public class HeaderFooterPortablePageEvent extends PdfPageEventHelper 
{
	private PdfPTable tableHeader;
	 
	public HeaderFooterPortablePageEvent(final PdfPTable tableHeader)
	{
    ...
    private void addHeader(final PdfWriter writer) throws Exception
    {
        try {
            ...
            float xPos = -50;
            float yPos = 840;
            tableHeader.writeSelectedRows(rowStart, rowEnd, xPos, yPos, canvas);
