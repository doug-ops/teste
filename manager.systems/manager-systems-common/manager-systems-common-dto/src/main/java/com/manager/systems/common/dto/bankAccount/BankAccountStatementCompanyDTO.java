...
public class BankAccountStatementCompanyDTO {
	...
	private Map<Long, BankAccountStatementAccountDTO> accounts = new TreeMap<Long, BankAccountStatementAccountDTO>();
	...
	public final Map<Long, BankAccountStatementAccountDTO> getAccounts() {
