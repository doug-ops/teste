...
public class ProductSubGroupServiceTest 
{
	...
	private ProductSubGroupService productSubGroupService = null;
	...
	public void inicializa() throws Exception
	{
		...
		this.productSubGroupService = new ProductSubGroupServiceImpl(this.connection);
	}
	...
	{		
		...
		Assert.assertNotNull(this.productSubGroupService);
		...
		final boolean isSaved = this.productSubGroupService.save(productSubGroup);
		Assert.assertTrue(isSaved);
		
		//Get
		productSubGroup = new ProductSubGroupDTO();
		productSubGroup.setId(1);
		this.productSubGroupService.get(productSubGroup);
		...
		productSubGroup.setChangeData(new ChangeData(1L));
		final boolean isInactive = this.productSubGroupService.inactive(productSubGroup);
		...
		productSubGroup.setInactive(false);
		productSubGroup.setChangeData(new ChangeData(1L));		
		final boolean isUpdated = this.productSubGroupService.save(productSubGroup);
		...
		this.productSubGroupService.getAll(reportProductSubGroup);
		...
		reportProductSubGroup.setInactive("0");
		reportProductSubGroup.setDescription("Teste2");
		final List<Combobox> items = this.productSubGroupService.getAllCombobox(reportProductSubGroup);
