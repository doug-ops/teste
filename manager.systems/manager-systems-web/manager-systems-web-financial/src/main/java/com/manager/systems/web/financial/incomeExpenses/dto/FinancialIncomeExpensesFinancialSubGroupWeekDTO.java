...
@Setter
@AllArgsConstructor
public class FinancialIncomeExpensesFinancialSubGroupWeekDTO implements Serializable {
	
	private static final long serialVersionUID = 6410085838021619221L;
